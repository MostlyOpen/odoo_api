...
def community_address_import_sqlite(
    ...
    for row in cursor:
        ...
        print(
            community_address_count, row['id'], row['community_id'], row['address_id'], row['role_id']
        )
        ...
        community_address_id = community_address_model.create(values).id
        ...
        if row['community_id']:
            ...
            community_address_model.write(community_address_id, values)
