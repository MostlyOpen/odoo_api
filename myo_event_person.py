...
def event_person_import_sqlite(
    ...
    for row in cursor:
        ...
        print(
            event_person_count, row['id'], row['event_id'], row['person_id'], row['role_id']
        )
        ...
        event_person_id = event_person_model.create(values).id
        ...
        if row['event_id']:
            ...
            event_person_model.write(event_person_id, values)
